...
namespace HlsService.Services.Devices
{
    ...
    /// Modbus TCP设备连接实现
    /// </summary>
    public class ModbusTcpConnection : DeviceConnectionBase
    {
        private ModbusTcpNet? _modbusClient;
        private readonly object _clientLock = new object();

        public ModbusTcpConnection(string deviceId) : base(deviceId, DeviceType.ModbusTcp)
        {
        }
